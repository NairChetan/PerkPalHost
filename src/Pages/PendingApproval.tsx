...
//         );
//       } catch (error) {
//         console.error("Rejection failed for panel", panelId, error);
//       }
//     }
//     setRefreshPage((refresh) => refresh + 1);
//   };
...
//                 <Button
//                   variant="contained"
//                   onClick={() => handleApprove(selectedPanels[0])} // Adjust for multiple selections
...
//                 <Button
//                   variant="contained"
//                   onClick={() => handleReject(selectedPanels[0])} // Adjust for multiple selections
//                   disabled={selectedPanels.length === 0}
//                 >
//                   Reject Selected
//                 </Button>
