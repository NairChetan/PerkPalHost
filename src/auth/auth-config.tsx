...
export const msalConfig = {
    auth: {
        ...
        redirectUri: 'https://perk-pal-host.vercel.app/', // Points to window.location.origin. You must register this URI on Microsoft Entra admin center/App Registration.
